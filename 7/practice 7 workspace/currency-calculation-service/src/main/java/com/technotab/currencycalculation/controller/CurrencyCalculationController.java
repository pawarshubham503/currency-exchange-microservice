package com.technotab.currencycalculation.controller;
...
import com.technotab.currencycalculation.facade.CurrencyExchangeProxy;
...
//	
//	@GetMapping("/currency-concverter/from/{from}/to/{to}/quantity/{quantity}")
//	public CalculatedAmount calculateAmount(@PathVariable String from,@PathVariable String to,
//			@PathVariable BigDecimal quantity) {
//		Map<String, String> uriVariables = new HashMap<>();
//		uriVariables.put("from", from);
//		uriVariables.put("to", to);
//		ResponseEntity<CalculatedAmount> responseEntity=new RestTemplate().getForEntity("http://localhost:8000/currency-excahnge/from/{from}/to/{to}",CalculatedAmount.class,uriVariables);
...
//	}
	...
	@GetMapping("/currency-concverter/from/{from}/to/{to}/quantity/{quantity}")
	public CalculatedAmount retrieveExchangeValue(@PathVariable String from,@PathVariable String to,
			@PathVariable BigDecimal quantity) {
